<div class="inline-block ml-2 align-middle md:ml-4">
    <button type="button" onclick="onDarkModeToggle()" class="inline-flex items-center justify-center p-2 rounded-md text-zinc-700 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-700" title="Toggle dark mode">
