<html>
	...
	<body>
		<div class="w-[1200px] h-[632px] relative flex items-center justify-center px-4 text-center text-white border-4 bg-brand-dark border-accent">
			<div>
			...
			@if(isset($category) || isset($date))
				<p class="absolute bottom-0 left-0 mb-4 ml-10 text-xl">
					@if(isset($date)) {{ $date }} @endif
					@if(isset($date) && isset($category)) // @endif
